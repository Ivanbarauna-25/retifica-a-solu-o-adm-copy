...
import { FileText, Search, Filter, DollarSign, AlertCircle, CheckCircle, Clock } from 'lucide-react';
          ...
          <div className="max-w-[1800px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold mb-1">Contas a Pagar</h1>
                  <p className="text-slate-300">Gestão de obrigações financeiras</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <Card className="border-l-4 border-l-yellow-500 shadow-sm">
              <CardContent className="p-6">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium text-slate-600 mb-1">A Pagar</p>
                    <div className="text-2xl font-bold text-yellow-600">{formatCurrency(stats.totalAPagar)}</div>
                  </div>
            ...
            <Card className="border-l-4 border-l-green-500 shadow-sm">
              <CardContent className="p-6">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium text-slate-600 mb-1">Pago</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        placeholder="Descrição, doc, fornecedor..."
                        value={busca}
                  ...
                  <div>
                    <Label className="text-xs font-medium text-gray-600 mb-1">Fornecedor</Label>
              ...
              <Table>
                <TableHeader className="bg-slate-700">
                  <TableRow>
                    ...
                    <TableHead className="text-white font-semibold text-right">Valor Pago</TableHead>
                  ...
                  {isLoading ? (
                    ...
                    contasFiltradas.map((conta) => (
                      <TableRow key={conta.id} className="hover:bg-slate-50">
                        ...
                        <TableCell className="text-slate-600">{getFornecedorNome(conta.fornecedor_id)}</TableCell>
                        ...
                        <TableCell className="text-right text-green-600 font-medium">{formatCurrency(conta.valor_pago || 0)}</TableCell>
                ...
                <tfoot className="bg-slate-50 font-semibold text-slate-900 border-t border-slate-200">
                  <tr>
                    ...
                    <td className="p-4 text-right text-green-700">{formatCurrency(contasFiltradas.reduce((acc, c) => acc + (c.valor_pago || 0), 0))}</td>
                    <td className="p-4"></td>
                  </tr>
                </tfoot>
              </Table>
