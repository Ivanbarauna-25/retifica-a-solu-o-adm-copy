    ...
    <>
      <div className="min-h-screen bg-slate-50">
          ...
          <div className="max-w-[1800px] mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 md:gap-4">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div>
                  <h1 className="text-sm md:text-xl font-bold">Patrimônio</h1>
                  <p className="text-slate-300 text-[9px] md:text-xs">Controle de bens e ativos</p>
                </div>
              </div>
        ...
        <div className="max-w-[1800px] mx-auto px-1 md:px-4">
          {/* Stats Cards */}
          <div className="grid grid-cols-3 gap-1.5 md:gap-3 mb-2 md:mb-4">
            ...
            <Card className="border-l-2 md:border-l-4 border-l-green-500 shadow-sm">
              <CardContent className="p-2 md:p-4">
                <div>
                  ...
                  <div className="text-xs md:text-lg font-bold text-green-600">{formatCurrency(stats.valorTotal)}</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-2 md:border-l-4 border-l-blue-500 shadow-sm">
              <CardContent className="p-2 md:p-4">
                <div>
                  <p className="text-[9px] md:text-xs font-medium text-slate-600 mb-0.5">Ativos</p>
                  <div className="text-sm md:text-xl font-bold text-blue-600">{stats.ativos}</div>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          {!showFilters && (
            <div className="bg-white rounded-lg shadow-sm p-2 md:p-3 mb-2 md:mb-3">
              <div className="relative">
                <Search className="absolute left-2 md:left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-3.5 h-3.5 md:w-4 md:h-4" />
                <Input
                  placeholder="Buscar..."
                  value={buscaCodigo}
                  onChange={(e) => setBuscaCodigo(e.target.value)}
                  className="pl-7 md:pl-9 text-xs md:text-sm h-8 md:h-9 border-slate-200"
                />
              </div>
            </div>
          )}
