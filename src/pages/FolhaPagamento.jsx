          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Gestão completa de pagamentos de funcionários</p>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                className="bg-transparent border-slate-600 text-white hover:bg-slate-700 hover:text-white gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <Button
                ...
                className="bg-transparent border-red-500 text-red-300 hover:bg-red-600 hover:text-white gap-2"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="border-l-4 border-l-green-500">
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-500 mt-1">{folhasFiltradas.filter((f) => f.status_pagamento === 'pago').length} lançamentos</p>
            </CardContent>
          </Card>

          <Card className="border-l-4 border-l-blue-500">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-slate-600">Parciais</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-700">{formatCurrency(totais.totalParcial)}</div>
              <p className="text-xs text-slate-500 mt-1">{folhasFiltradas.filter((f) => f.status_pagamento === 'pago_parcial').length} lançamentos</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-yellow-500">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-700">{formatCurrency(totais.totalPendente)}</div>
              <p className="text-xs text-slate-500 mt-1">{folhasFiltradas.filter((f) => f.status_pagamento === 'pendente').length} lançamentos</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
            <div className="relative">
              ...
              <Input type="text" placeholder="Buscar por funcionário ou competência..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10" />
            </div>
          </div>
