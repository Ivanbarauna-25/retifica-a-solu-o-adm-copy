    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="w-full max-w-[95vw] md:max-w-6xl h-[95vh] md:max-h-[90vh] overflow-hidden modern-modal bg-white flex flex-col p-0">
          ...
          <div className="processar-itens-scroll flex-1 px-4 md:px-6 pb-4 md:pb-6 space-y-4 md:space-y-6 mt-4 md:mt-6">
          ...
          <DialogFooter className="flex-shrink-0 bg-white p-3 md:p-4 border-t flex justify-end gap-2 md:gap-3">
            <Button
              variant="outline"
              onClick={onClose}
              disabled={isProcessing}
