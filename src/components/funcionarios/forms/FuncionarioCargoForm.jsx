    ...
    <>
      ...
      {isOpen && (
        <div className="fixed left-[50%] top-[50%] z-50 grid w-full max-w-[95vw] md:max-w-2xl h-[95vh] md:max-h-[90vh] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-white p-0 shadow-lg duration-200 sm:rounded-lg overflow-hidden flex flex-col">
          <div className="modern-modal-header flex-shrink-0 bg-slate-800 px-3 md:px-6 py-3 md:py-4 sticky top-0 z-10">
          ...
          <div className="cargo-form-scroll flex-1 px-3 md:px-6 pb-3 md:pb-6">
            <form onSubmit={handleSubmit} id="cargo-form" className="space-y-3 md:space-y-4 mt-3 md:mt-4">
          ...
          <div className="flex-shrink-0 flex flex-col-reverse sm:flex-row justify-end gap-2 md:gap-3 px-3 md:px-6 py-3 md:py-4 border-t bg-white">
            <Button 
              type="button" 
              variant="outline" 
              onClick={onClose}
